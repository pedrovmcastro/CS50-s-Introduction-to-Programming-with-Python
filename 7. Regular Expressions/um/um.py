...
def count(s):
    """
    Count the number of times that “um” appears in a text, case-insensitively, as a word unto itself, not as a substring of some other word.

    :param s: A string representing a line of text.
    :return: The number of times that "um" appears in the text.
    """
